...
import { forkJoin, map, switchMap, every } from 'rxjs';
import { CUSTOM_ELEMENTS_SCHEMA } from '@angular/core';
import { register } from 'swiper/element/bundle';
import { PokemonWeaknesses, Generation} from '../../models/PokemonWeakness';
...
export class HomePage {
  ...
  altura: string = "";
  peso: string = "";
  rangeValue = { lower: 10, upper: 20 };

  generacionSeleccionada: string = "generation-ii";
